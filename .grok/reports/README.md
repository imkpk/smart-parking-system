...
| [app-shell-sidebar-collapse-behavior.md](./app-shell-sidebar-collapse-behavior.md) | App shell sidebar — collapsed by default, 2 min auto-close on desktop | `fix/app-shell-sidebar-collapse-behavior` |
