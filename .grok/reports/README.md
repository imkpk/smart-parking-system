...
| [phase-2-frontend-branding-provider.md](./phase-2-frontend-branding-provider.md) | Phase 2 frontend branding provider (LOOP 2C) | `feature/phase-2-frontend-branding-provider` |
