...
|------|---------|--------|---------|
| 2026-06-26 | 1.16.4 | Agent | Dashboard onboarding fan-out fix: `GET /api/dashboard/onboarding-status` replaces per-lot floors/slots queries; throttle default 120/min; dashboard `staleTime` 30s; Cypress network smoke. |
